...
const Hero = () => {
  return (
    <section className={`${styles.paddingX} absolute overflow-x-hidden min-h-screen`}>
        ...
        <img className='w-[350px] h-[350px] absolute -left-44 top-1/2 -z-10' src={ornament} alt='ornamnet' />
        <img className='w-[350px] h-[350px] absolute overflow-clip -right-44 top-32 -z-10' src={ornament} alt='ornamnet' />
